...
class AD9959ArduinoComm ( IntermediateDevice ):
    ...
    def __init__ ( self , name , com_port, channel_mappings, div_32=False, channels=['ch0', 'ch1', 'ch2', 'ch3'], baud_rate = 115200, **kwargs):
        """ initialize device
        ...
        self.lower_lim = .01 # MHz
        self.upper_lim = 400 # MHz
        if div_32:
            self.lower_lim = .01*32 # MHz
            self.upper_lim = 400*32 # MHz
