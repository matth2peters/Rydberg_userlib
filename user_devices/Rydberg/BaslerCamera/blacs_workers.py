#####################################################################
#                                                                   #
# /labscript_devices/BaslerCamera/blacs_workers.py                   #
#                                                                   #
...
class BaslerCamera(object):
    def __init__(self, serial_number):
        ...
        self.camera = pylon.InstantCamera(pylon.TlFactory_GetInstance().CreateFirstDevice())
        self.camera.Open()
...
class BaslerCameraWorker(IMAQdxCameraWorker):
